  ...
  try {
    ...
    const services = [
      // Playing Services (4)
      {
        ...
        tags: ['Match Player', 'Tournament', 'Professional', 'Team Player'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2095, 13.0850],
        serviceType: 'in-person',
        deliveryTime: '4-8 hours',
        requirements: ['Match venue', 'Team coordination', 'Cricket gear'],
        isActive: true,
        rating: 4.9,
        reviewCount: 45,
      },
      {
        ...
        providerId: freelancer1.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Bowling', 'Fast Bowling', 'Spin Bowling', 'Practice'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2095, 13.0850],
        serviceType: 'in-person',
      ...
      },
      {
        ...
        providerId: freelancer1.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Batting', 'Net Practice', 'Match Play'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2095, 13.0850],
        serviceType: 'in-person',
        deliveryTime: '2 hours',
        requirements: ['Cricket ground', 'Batting gear'],
        isActive: true,
        rating: 4.7,
        reviewCount: 20,
      },
      {
        ...
        tags: ['Sidearm', 'Practice', 'Training'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2095, 13.0850],
        serviceType: 'in-person',
        deliveryTime: '1 hour',
        requirements: ['Practice ground', 'Cricket balls'],
        isActive: true,
        rating: 4.6,
        reviewCount: 15,
      },
      ...
      // Coaching & Training (3)
      {
        ...
        tags: ['Coaching', 'Training', 'Technique', 'Strategy'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'in-person',
        deliveryTime: '2 hours',
      ...
      },
      {
        ...
        providerId: freelancer2.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Conditioning', 'Fitness', 'Strength', 'Agility'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'in-person',
        deliveryTime: '1.5 hours',
        requirements: ['Gym access', 'Training equipment'],
        isActive: true,
        rating: 4.8,
        reviewCount: 30,
      },
      {
        ...
        providerId: freelancer2.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Fitness', 'Gym', 'Cardio', 'Strength Training'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'in-person',
        deliveryTime: '1.5 hours',
        requirements: ['Gym access', 'Fitness equipment'],
        isActive: true,
        rating: 4.7,
        reviewCount: 28,
      },
      ...
      // Support Staff (4)
      {
        ...
        providerId: freelancer2.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Analysis', 'Data', 'Strategy', 'Performance'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'hybrid',
        deliveryTime: '3 hours',
        requirements: ['Match footage', 'Performance data'],
        isActive: true,
        rating: 4.9,
        reviewCount: 18,
      },
      {
        ...
        providerId: freelancer2.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Physiotherapy', 'Injury', 'Recovery', 'Treatment'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'in-person',
        deliveryTime: '1 hour',
        requirements: ['Medical history', 'Treatment space'],
        isActive: true,
        rating: 4.8,
        reviewCount: 35,
      },
      {
        ...
        providerId: freelancer1.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Scoring', 'Match', 'Statistics'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2095, 13.0850],
        serviceType: 'in-person',
        deliveryTime: '4 hours',
        requirements: ['Scoring equipment', 'Match venue access'],
        isActive: true,
        rating: 4.7,
        reviewCount: 22,
      },
      {
        ...
        providerId: freelancer1.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Umpiring', 'Officiating', 'Match', 'Rules'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2095, 13.0850],
        serviceType: 'in-person',
        deliveryTime: '4 hours',
        requirements: ['Umpiring gear', 'Match venue access'],
        isActive: true,
        rating: 4.9,
        reviewCount: 40,
      },
      ...
      // Media & Content (3)
      {
        ...
        providerId: freelancer2.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Photography', 'Videography', 'Media', 'Content'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'in-person',
        deliveryTime: '4 hours',
        requirements: ['Camera equipment', 'Event access'],
        isActive: true,
        rating: 4.9,
        reviewCount: 50,
      },
      {
        ...
        providerId: freelancer2.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Content', 'Social Media', 'Digital', 'Creator'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'hybrid',
        deliveryTime: '3 hours',
      ...
      },
      {
        ...
        providerId: freelancer2.id,
        images: ['/images/Bowler & batsman.png'],
        tags: ['Commentary', 'Broadcasting', 'Match', 'Voice'],
        location: 'Chennai, Tamil Nadu',
        coords: [80.2279, 13.0418],
        serviceType: 'in-person',
        deliveryTime: '4 hours',
        requirements: ['Commentary booth', 'Broadcasting equipment'],
        isActive: true,
        rating: 4.9,
        reviewCount: 28,
      },
