  ...
  try {
    ...
    const profile1 = await prisma.freelancerProfile.upsert({
      ...
      create: {
        ...
        coords: JSON.stringify([80.2279, 13.0418]), // T Nagar, Chennai
        serviceRadius: 50.0,
        isOnline: true,
        isVerified: true,
        verifiedAt: new Date(),
    ...
    const profile2 = await prisma.freelancerProfile.upsert({
      ...
      create: {
        ...
        coords: JSON.stringify([80.2095, 13.0850]), // Chepauk, Chennai
        serviceRadius: 30.0,
        isOnline: true,
        isVerified: true,
        verifiedAt: new Date(),
    ...
    await prisma.portfolio.create({
      data: {
        ...
        images: JSON.stringify(['/images/portfolio/coaching1.jpg']),
        skills: JSON.stringify(['Batting Techniques', 'Mental Training', 'Match Strategy']),
    ...
    await prisma.portfolio.create({
      data: {
        ...
        images: JSON.stringify(['/images/portfolio/bowling1.jpg']),
        skills: JSON.stringify(['Fast Bowling', 'Pace Variations', 'Death Overs']),
    ...
    if (coachingCategory) {
      await prisma.service.create({
        data: {
          ...
          images: JSON.stringify(['/images/services/ai-consultation.jpg']),
          tags: JSON.stringify(['AI', 'Consultation', 'Machine Learning', 'Technology']),
          location: 'Chennai, Tamil Nadu',
          coords: JSON.stringify([80.2279, 13.0418]),
          serviceType: 'online',
          deliveryTime: '1 week',
      ...
      await prisma.service.create({
        data: {
          ...
          categoryId: coachingCategory.id,
          providerId: freelancer1.id,
          images: JSON.stringify(['/images/services/batting-coaching.jpg']),
          tags: JSON.stringify(['Batting', 'Coaching', 'Technique', 'Video Analysis']),
          location: 'Chennai, Tamil Nadu',
          coords: JSON.stringify([80.2279, 13.0418]),
    ...
    if (playingCategory) {
      await prisma.service.create({
        data: {
          ...
          images: JSON.stringify(['/images/services/bowling.jpg']),
          tags: JSON.stringify(['Fast Bowling', 'Net Practice', 'Pace', 'Training']),
    ...
    await prisma.job.create({
      data: {
        ...
        coords: JSON.stringify([80.2707, 13.0338]),
        skills: JSON.stringify(['Cricket Coaching', 'Batting Techniques', 'Bowling Techniques', 'Fielding Drills']),
        workMode: 'onsite',
        type: 'part-time',
        duration: 'monthly',
        experience: 'Expert',
