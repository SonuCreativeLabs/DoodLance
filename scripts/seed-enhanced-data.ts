  ...
  try {
    ...
    await prisma.clientProfile.upsert({
      ...
      create: {
        ...
        hireRate: 92.5,
        avgRating: 4.9,
        preferredSkills: JSON.stringify(['Fast Bowling', 'Sidearm Specialist', 'Content Creation']),
        isVerified: true,
        verifiedAt: new Date(),
      },
    })
    ...
    await prisma.clientProfile.upsert({
      ...
      create: {
        ...
        hireRate: 88.0,
        avgRating: 4.7,
        preferredSkills: JSON.stringify(['Mystery Spin', 'Cricket Analysis', 'Net Bowling']),
        isVerified: true,
        verifiedAt: new Date(),
      },
    })
    ...
    await prisma.clientProfile.upsert({
      ...
      create: {
        ...
        hireRate: 90.0,
        avgRating: 4.8,
        preferredSkills: JSON.stringify(['Cricket Photography', 'Scoring', 'Umpiring']),
        isVerified: true,
        verifiedAt: new Date(),
      },
    })
    ...
    const job1 = await prisma.job.create({
      data: {
        ...
        coords: JSON.stringify([80.2707, 13.0338]),
        skills: JSON.stringify(['Cricket Coaching', 'Batting Techniques', 'Bowling Techniques', 'Fielding Drills', 'Team Management']),
        workMode: 'onsite',
        type: 'part-time',
    ...
    const job2 = await prisma.job.create({
      data: {
        ...
        coords: JSON.stringify([80.2095, 13.0850]),
        skills: JSON.stringify(['Sidearm Throwing', 'Fast Bowling Simulation', 'Spin Bowling Simulation', 'Cricket Training']),
        workMode: 'onsite',
        type: 'contract',
    ...
    const job3 = await prisma.job.create({
      data: {
        ...
        location: 'Anna Nagar Cricket Club, Chennai',
        coords: JSON.stringify([80.2090, 13.0850]),
        skills: JSON.stringify(['Mystery Spinner', 'Bowling Techniques', 'Carrom Ball', 'Doosra']),
        workMode: 'onsite',
        type: 'freelance',
        duration: '2 hours per session',
        experience: 'Expert',
    ...
    const job4 = await prisma.job.create({
      data: {
        ...
        location: 'T Nagar Cricket Academy, Chennai',
        coords: JSON.stringify([80.2279, 13.0418]),
        skills: JSON.stringify(['One-on-One Coaching', 'Batting Techniques', 'Footwork', 'Cricket Training']),
        workMode: 'onsite',
        type: 'part-time',
    ...
    const job5 = await prisma.job.create({
      data: {
        ...
        location: 'Adyar Cricket Ground, Chennai',
        coords: JSON.stringify([80.2570, 13.0067]),
        skills: JSON.stringify(['Fast Bowler', 'Net Bowler', 'Cricket Training', 'Pace Bowling']),
        workMode: 'onsite',
        type: 'freelance',
        duration: '2 hours',
        experience: 'Expert',
    ...
    const job6 = await prisma.job.create({
      data: {
        ...
        location: 'Velachery Cricket Academy, Chennai',
        coords: JSON.stringify([80.2209, 12.9756]),
        skills: JSON.stringify(['Cricket Analyst', 'Video Analysis', 'Performance Analysis', 'Cricket Techniques']),
        workMode: 'hybrid',
        type: 'contract',
        duration: '4 hours',
        experience: 'Expert',
    ...
    const job7 = await prisma.job.create({
      data: {
        ...
        location: 'M.A. Chidambaram Stadium, Chennai',
        coords: JSON.stringify([80.2095, 13.0850]),
        skills: JSON.stringify(['Cricket Photography', 'Sports Photography', 'Action Shots', 'Photo Editing']),
        workMode: 'onsite',
        type: 'contract',
    ...
    const job8 = await prisma.job.create({
      data: {
        ...
        location: 'Chepauk, Chennai',
        coords: JSON.stringify([80.2095, 13.0850]),
        skills: JSON.stringify(['Cricket Content Creation', 'Video Editing', 'Social Media', 'Cricket Knowledge']),
        workMode: 'hybrid',
        type: 'contract',
    ...
    const job9 = await prisma.job.create({
      data: {
        ...
        location: 'Various Grounds, Chennai',
        coords: JSON.stringify([80.2707, 13.0338]),
        skills: JSON.stringify(['Cricket Umpire', 'Rules Knowledge', 'Decision Making', 'Communication']),
        workMode: 'onsite',
        type: 'contract',
    ...
    const job10 = await prisma.job.create({
      data: {
        ...
        coords: JSON.stringify([80.2090, 13.0850]),
        skills: JSON.stringify(['Cricket Scorer', 'Digital Scoring', 'Cricket Statistics', 'Match Analysis']),
        workMode: 'onsite',
        type: 'contract',
    ...
    const job11 = await prisma.job.create({
      data: {
        ...
        location: 'Nungambakkam Cricket Club, Chennai',
        coords: JSON.stringify([80.2420, 13.0569]),
        skills: JSON.stringify(['Cricket Physio', 'Sports Therapy', 'Injury Management', 'Recovery Techniques']),
        workMode: 'onsite',
        type: 'part-time',
    ...
    await prisma.application.create({
      data: {
        ...
        estimatedDays: 20,
        skills: JSON.stringify(['Sidearm Throwing', 'Fast Bowling Simulation', 'Spin Bowling Simulation', 'Cricket Training']),
        attachments: JSON.stringify(['experience_certificate.pdf', 'testimonials.pdf']),
        status: 'PENDING',
        progress: 0,
      },
    })
    ...
    await prisma.application.create({
      data: {
        ...
        proposedRate: 4500,
        estimatedDays: 15,
        skills: JSON.stringify(['Mystery Spin', 'Carrom Ball', 'Doosra', 'Spin Coaching', 'Cricket Training']),
        attachments: JSON.stringify(['spin_credentials.pdf', 'playing_history.pdf']),
        status: 'PENDING',
        progress: 0,
      },
    })
    ...
    await prisma.application.create({
      data: {
        ...
        proposedRate: 3000,
        estimatedDays: 30,
        skills: JSON.stringify(['One-on-One Coaching', 'Batting Technique', 'Footwork Training', 'Youth Development', 'Video Analysis']),
        attachments: JSON.stringify(['coaching_certificate.pdf', 'training_methodology.pdf']),
        status: 'PENDING',
        progress: 0,
      },
    })
    ...
    await prisma.application.create({
      data: {
        ...
        proposedRate: 2200,
        estimatedDays: 4,
        skills: JSON.stringify(['Cricket Scoring', 'Digital Scoring', 'Match Statistics', 'Cricket Knowledge']),
        attachments: JSON.stringify(['scoring_certificate.pdf', 'tournament_experience.pdf']),
        status: 'ACCEPTED',
        progress: 100,
      },
    })
    ...
    await prisma.application.create({
      data: {
        ...
        proposedRate: 4000,
        estimatedDays: 7,
        skills: JSON.stringify(['Cricket Analysis', 'Video Analysis', 'Performance Metrics', 'Technical Feedback']),
        attachments: JSON.stringify(['analysis_portfolio.pdf', 'cricket_certifications.pdf']),
        status: 'REJECTED',
        progress: 0,
      },
    })
