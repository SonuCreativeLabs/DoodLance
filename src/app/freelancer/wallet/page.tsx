...
import { Wallet, ArrowUpRight, ArrowDownLeft, Clock, Calendar, ChevronRight, TrendingUp, AlertCircle, Loader2, ArrowLeft } from 'lucide-react';
...
export default function WalletPage() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white pb-20 relative">
      {/* Header with Back Button - Matches Freelancer Pages */}
      <div className="sticky top-0 z-50 bg-[#111111]/95 backdrop-blur-md border-b border-white/10">
      ...
      {/* Coming Soon Overlay - Blurs content below */}
      <ComingSoonOverlay>

        {/* Content with top padding for fixed header */}
        <div className="pt-[72px] p-4 space-y-6 max-w-2xl mx-auto">
          {/* Balance Card */}
          <motion.div
