...
function AdminLayoutContent({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <AnimatePresence>
        {(sidebarOpen || mobileMenuOpen) && (
          <motion.aside
            ...
            animate={{ x: 0 }}
            exit={{ x: -300 }}
            className={`fixed left-0 top-0 h-full bg-[#1a1a1a] border-r border-gray-800 z-40 ${
              sidebarOpen ? 'w-64' : 'w-0'
            } ${mobileMenuOpen ? 'w-64' : 'lg:w-64'}`}
          >
              ...
              <div className="p-6 pb-0">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-white">DoodLance</h2>
      ...
      {/* Main Content */}
      <main className={`flex-1 overflow-y-auto bg-[#0a0a0a] transition-all duration-300 ${
        ...
        {/* Page Content with max width to prevent overlap */}
        <div className="p-6 max-w-[calc(100%-1rem)] mx-auto">
          {children}
        </div>
      </main>
    </div>
