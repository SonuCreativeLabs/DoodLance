...
export default function WelcomePage() {
    ...
    const handleGetStarted = () => {
        // Explicitly go to login, as this is the "Login Gateway"
                            ...
                            >
                                ...
                                <div className="flex justify-center w-full">
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="group px-8 py-4 rounded-full bg-gradient-to-r from-[#6B46C1] via-[#4C1D95] to-[#2D1B69] text-white font-bold text-xl flex items-center gap-2 shadow-xl hover:shadow-[#4C1D95]/40 transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-[#6B46C1] disabled:opacity-50"
                                    >
                                        Lets Play <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                                    </motion.button>
                                </div>
                            </motion.div>
                        </div>
