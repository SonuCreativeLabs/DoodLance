...
return (
  <div className="w-full text-foreground bg-[#111111] h-screen flex flex-col overflow-hidden">
    {/* Fixed Header */}
    <div className="fixed-header w-full bg-[#111111] fixed top-[64px] left-0 right-0 z-40 pt-2">
...
{/* Scrollable Content */}
<div className="pt-24 h-[calc(100vh-64px)] overflow-hidden">
  <div className="scrollable-content h-full overflow-y-auto scroll-smooth overscroll-contain scrollbar-hide">
    <div className="w-full max-w-[1800px] mx-auto pb-8 px-4">
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
