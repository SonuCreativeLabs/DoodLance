  ...
  return (
    <ChatViewProvider>
      <div className={cn("min-h-screen bg-[#111111] flex flex-col overflow-x-hidden", className)}>
        <main className={cn("flex-1 flex flex-col w-full overflow-x-hidden", !shouldHideNavbar && "pb-16")}>
            ...
            <div className="grid grid-cols-5 items-center h-16">
              ...
              >
                <div className={cn(
                  ...
                  pathname === "/client" || pathname === "/client/" ? "text-purple-500" : "text-gray-400"
                )}>
              ...
              >
                <div className={cn(
                  "flex flex-col items-center",
                  pathname.startsWith("/client/bookings") ? "text-purple-500" : "text-gray-400"
                )}>
              ...
              >
                <div className={cn(
                  "flex flex-col items-center",
                  pathname.startsWith("/client/nearby") ? "text-purple-500" : "text-gray-400"
                )}>
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              >
                <div className={cn(
                  "flex flex-col items-center",
                  pathname.startsWith("/client/inbox") ? "text-purple-500" : "text-gray-400"
                )}>
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
